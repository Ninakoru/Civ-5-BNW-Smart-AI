...
#if defined (MOD_AI_CORE_UNITS_WEIGHT_BOOST)
...
#if !defined(MOD_AI_SMART_PUPPET_TRAINING_BUILDINGS)
...
#if defined(MOD_AI_SMART_WONDER_SANITY_CHECK)
...
bool CityStrategyAIHelpers::IsTestCityStrategy_NeedTileImprovers(AICityStrategyTypes eStrategy, CvCity* pCity)
{
	...
	{
#if defined (MOD_AI_SMART_FLEXIBLE_NEED_TILE_IMPROVERS)
		CvCity* pLoopCity = NULL;
		int iLoop = 0;
